...
class msa_muscle(object):
    ...
    def build_msa(self, workspace_name, featureset_id, msa_id, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method build_msa: argument json_rpc_context is not type dict as required.')
        resp = self._call('msa_muscle.build_msa',
                          [workspace_name, featureset_id, msa_id], json_rpc_context)
        return resp[0]
